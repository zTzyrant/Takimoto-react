...
export function RoomSceneComponent(props: JSX.IntrinsicElements["group"]) {
  const group = React.useRef<THREE.Group | null>(null);
  const { scene } = useGLTF("models/roomScene.glb");
  ...
  //     // Assuming you want to play the first clip
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group
          name="Node001"
          position={[0.36, 0.291, -1.109]}
          rotation={[-Math.PI, 1.556, -Math.PI]}
          scale={[0.038, 0.031, 0.038]}
        >
          <mesh
            name="Node-Mesh003"
            geometry={nodes["Node-Mesh003"].geometry}
            material={materials["Executive.001"]}
          />
          <mesh
            name="Node-Mesh003_1"
            geometry={nodes["Node-Mesh003_1"].geometry}
            material={materials["Executive__1.001"]}
          />
          <mesh
            name="Node-Mesh003_2"
            geometry={nodes["Node-Mesh003_2"].geometry}
            material={materials["Executive__2.001"]}
          />
          <mesh
            name="Node-Mesh003_3"
            geometry={nodes["Node-Mesh003_3"].geometry}
            material={materials["Executive__3.001"]}
          />
        </group>
        <mesh
          name="Plane"
        ...
        <group name="group614062749" position={[1.747, 0.323, -1.592]} scale={0.308}>
          ...
          />
          <mesh
            name="mesh614062749_1"
            geometry={nodes.mesh614062749_1.geometry}
            material={materials.mat8}
          />
          <mesh
            name="mesh614062749_2"
        ...
        <group name="group1002021246" position={[1.747, 0.323, -1.592]} scale={0.308}>
          ...
          />
          <mesh
            name="mesh1002021246_1"
            geometry={nodes.mesh1002021246_1.geometry}
            material={materials.mat16}
          />
        </group>
        <mesh
          name="group1004135894"
        ...
        <group name="group1125399115" position={[1.747, 0.323, -1.592]} scale={0.308}>
          ...
          />
          <mesh
            name="mesh1125399115_1"
            geometry={nodes.mesh1125399115_1.geometry}
            material={materials.mat15}
          />
        </group>
        <mesh
          name="group1144869753"
        ...
        <group name="group1221721378" position={[1.747, 0.323, -1.592]} scale={0.308}>
          ...
          />
          <mesh
            name="mesh1221721378_1"
            geometry={nodes.mesh1221721378_1.geometry}
            material={materials.mat23}
          />
        </group>
        <mesh
          name="group1247630253"
        ...
        <group name="group1264231965" position={[1.747, 0.323, -1.592]} scale={0.308}>
          ...
          />
          <mesh
            name="mesh1264231965_1"
            geometry={nodes.mesh1264231965_1.geometry}
            material={materials.mat17}
          />
        </group>
        <mesh
          name="group1275655566"
        ...
        <group name="group1517310649" position={[1.747, 0.323, -1.592]} scale={0.308}>
          ...
          />
          <mesh
            name="mesh1517310649_1"
            geometry={nodes.mesh1517310649_1.geometry}
            material={materials.mat23}
          />
        </group>
        <mesh
          name="group1526395978"
        ...
        <group name="group1693732898" position={[1.747, 0.323, -1.592]} scale={0.308}>
          ...
          />
          <mesh
            name="mesh1693732898_1"
            geometry={nodes.mesh1693732898_1.geometry}
            material={materials.mat17}
          />
        </group>
        <mesh
          name="group1714365479"
        ...
        <group name="group1722992837" position={[1.747, 0.323, -1.592]} scale={0.308}>
          ...
          />
          <mesh
            name="mesh1722992837_1"
            geometry={nodes.mesh1722992837_1.geometry}
            material={materials.mat23}
          />
        </group>
        <mesh
          name="group1724716729"
        ...
        <group name="group1783485154" position={[1.747, 0.323, -1.592]} scale={0.308}>
          ...
          />
          <mesh
            name="mesh1783485154_1"
            geometry={nodes.mesh1783485154_1.geometry}
            material={materials.mat16}
          />
        </group>
        <mesh
          name="group1788593855"
        ...
        <group name="group1841586256" position={[1.747, 0.323, -1.592]} scale={0.308}>
          ...
          />
          <mesh
            name="mesh1841586256_1"
            geometry={nodes.mesh1841586256_1.geometry}
            material={materials.mat15}
          />
        </group>
        <mesh
          name="group1851189319"
        ...
        <group name="group2029488445" position={[1.747, 0.323, -1.592]} scale={0.308}>
          ...
          />
          <mesh
            name="mesh2029488445_1"
            geometry={nodes.mesh2029488445_1.geometry}
            material={materials.mat23}
          />
        </group>
        <mesh
          name="group2032200821"
